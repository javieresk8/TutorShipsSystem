        ...
        <div class="card login-form text-white">
            ...
            <div style="display: flex; justify-content: space-between;">
                ...
                <div class="mb-3">
                    ...
                    <input class="form-control custom-input text-white-50" type="email" id="email"
                        name="email" pattern=".+@epn.edu.\.com" />
                </div>
            </div>
                <div class="mb-3" style="min-width: 100%;">
                    <label class="form-label" for="identityNumber">Career</label>
                    <input style="min-width: 100%;" class="form-control custom-input text-white-50" type="text" id="career"
                        name="career" />
                </div>
            </div>
