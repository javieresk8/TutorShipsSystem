...
<body class="text-white">
    ...
    <div class="container">
        <p class="fs-1">Update administrator</p>
        <form class="p-2 form" method="POST" action="UpdateUserController">
         <input class="auto" id="rol" name="rol" value="Admin" style="display: none"/>
         <input class="auto" id="idAct" name="idAct" value="${ user.getIdUsuario() }" style="display: none"/>
